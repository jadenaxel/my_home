var app = (function () {
        ...
        return {
            c() {
                ...
                f(i, "class", "settings-title svelte-1wspjot"),
                    r(i.src, (l = "/images/logo.svg")) ||
                        f(i, "src", "/images/logo.svg"),
                    f(i, "alt", "Logo"),
    ...
    function R(e) {
        return [
            [
                "/images/icons/settings/chart.svg",
                "/images/icons/settings/union.svg",
                "/images/icons/settings/bookmark.svg",
                "/images/icons/settings/settings.svg",
            ],
        ];
    }
    class U extends M {
